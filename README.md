...
This repository will help you to test DR-DME AI models for multi-class classification using retinal fundus images by employing deep learning (DL) methodology. 

This repository is prepared based on production-level standards.

It can also be adopted to test any AI model for multi-class classification using 2D/3D data.
